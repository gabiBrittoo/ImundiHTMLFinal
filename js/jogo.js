...
const checkEndGame = () => {
    ...
    /*Retornando ao jogador que o jogo acabou*/
      ...
      alert(`Parabéns! Você completou o jogo da memória :) Para jogar novamente, reinicie a página ;)`)
    }
} 
...
const createCard = (carta) => {
    ...
    front.style.backgroundImage = (`url('../ImundiHTMLFinal/ImundiHTMLFinal/img/ImagensCards${carta}.png')`);
